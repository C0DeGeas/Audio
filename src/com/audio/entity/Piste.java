...
public class Piste {
    ...
    public Piste(String name,  String link){
        this(name,null,null,link);
    }
    public Piste( String name, Date dateOfCreation, Date dateOfLastMod, String link){
        this(name, null, dateOfCreation, dateOfLastMod,link);
    }
    public Piste( String name, String author, Date dateOfCreation, Date dateOfLastMod, String link) {
        this.name = name;
        this.author= author;
